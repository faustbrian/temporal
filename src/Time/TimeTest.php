...
final class TimeTest extends TestCase
{
    ...
    {
        $this->assertNotInstanceOf(Time::class, Time::parse('99:99:99'));
    }
    ...
    public function test_invalid_separator_throws(string $separator): void
    {
    ...
    {
        $this->assertNotInstanceOf(Time::class, Time::parse('12-12-douze', '-'));
    }
    ...
    public function test_format_default(): void
    {
        ...
        $this->assertSame('09:05:03', $time->toString());
    }
    ...
    public function test_format_with_microseconds(): void
    {
        ...
        $this->assertSame('01:02:03.000045', $time->toString());
    }
    ...
    public function test_format_auto_microseconds(): void
    {
        ...
        $this->assertSame('01:02:03', $time->toString());
    }
    ...
    public function test_add_without_argument_changes_nothing(): void
    {
        ...
        $this->assertSame($time, $time->add(Duration::of()));
    }
    ...
    public function test_diff_signed(): void
    {
        ...
        $this->assertSame(2 * 3_600_000_000, $a->diff($b)->total(Unit::Microsecond));
    }
    ...
    public function test_diff_forward_wraps(): void
    {
        ...
        $this->assertSame(2 * 3_600_000_000, $diff->total(Unit::Microsecond));
    }
    ...
    public function test_zero_add_returns_same_instance(): void
    {
        ...
        $this->assertSame($time, $time->add(Duration::zero()));
    }

    public function test_microseconds(): void
    {
        $this->assertSame(10 * 3_600_000_000, Time::at(10)->toUnitOfDay(Unit::Microsecond));
    }
    ...
    public function test_with_updates_selected_components(
        ...
        $this->assertSame($expected, $original->with(...$arguments)->toString());
    }
    ...
    public function test_with_preserves_original_instance(): void
    {
        ...
        $this->assertSame('23:54:23', $original->toString());
        $this->assertSame('08:54:23', $updated->toString());
    ...
    public function test_truncate_and_round(
        ...
        $this->assertSame($expectedTruncate, $time->roundTo($precision, RoundingMode::Floor)->toUnitOfDay(Unit::Microsecond));
        $this->assertSame($expectedRound, $time->roundTo($precision)->toUnitOfDay(Unit::Microsecond));
        $this->assertSame($expectedCeil, $time->roundTo($precision, RoundingMode::Ceil)->toUnitOfDay(Unit::Microsecond));
    }
