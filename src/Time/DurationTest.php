...
final class DurationTest extends TestCase
{
    public function test_parse_microseconds(): void
    {
        ...
        $this->assertSame('5w 6d 2h 15m 42s 123456µs', $duration->toNotation(DurationNotation::Compact));
    }
    ...
    public function test_parse_negative_microseconds(): void
    {
        ...
        $this->assertSame(-1, $duration->sign);
        $this->assertSame('-1s 500000µs', $duration->toNotation(DurationNotation::Compact));
    }
    ...
    {
        $duration = Duration::of(microseconds: -500_000);
    ...
    {
        $this->assertSame($expected, Duration::of(microseconds: $microseconds)->toNotation());
    }
     ...
     */
    public static function provideWithCases(): iterable
    {
        $base = Duration::of(
            hours: 12,
            minutes: 34,
    ...
    public function test_with_returns_same_instance_when_called_without_arguments(): void
    {
        ...
        $this->assertSame($duration, $duration->increment());
    }
    ...
    public function test_round_to(int $input, Unit $precision, int $expected): void
    {
        ...
        $this->assertSame($expected, $duration->roundTo($precision, RoundingMode::Round)->total(Unit::Microsecond));
    }
    ...
    {
        $this->assertTrue(Duration::fromNotation($notation, DurationNotation::Chrono)->equals(Duration::of(seconds: $seconds, milliseconds: $milliseconds ?? 0)));
    }
    ...
    {
        $this->assertTrue(Duration::fromNotation($notation, DurationNotation::Compact)->equals(Duration::of(seconds: $seconds, microseconds: $microseconds ?? 0)));
    }
