...
final class DatePointTest extends TestCase
{
    ...
    #[DataProvider('provideIs_duringCases')]
     ...
     */
    public static function provideIs_duringCases(): iterable
    {
        yield 'contains returns true with a DateTimeInterface object' => [
            Period::fromDate(
                CarbonImmutable::parse('2014-03-10'),
                CarbonImmutable::parse('2014-03-15'),
            ),
        ...
        yield 'contains returns false with a DateTimeInterface object' => [
            Period::fromDate(
                CarbonImmutable::parse('2014-03-13'),
                CarbonImmutable::parse('2014-03-15'),
            ),
